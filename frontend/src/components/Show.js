        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <dl>
              ...
              <dt>Email Address:</dt>F
              <dd>{this.state.contact.email}</dd>
            </dl>
            <Link to={`/edit/${this.state.contact.id}`} class="btn btn-success">Editar</Link>&nbsp;
            <button onClick={this.delete.bind(this, this.state.contact.id)} class="btn btn-danger">Eliminar</button>
          </div>
        </div>
      </div>
    );
